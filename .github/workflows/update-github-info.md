...
3. Use the web-fetch tool to read external public guidance from both of these exact URLs:
...
5. Identify relevant, recent GitHub announcements and changelog entries. Prefer authoritative facts from the fetched pages, preserve useful existing content, and do not invent details.
